...
def create_arg_parser() -> argparse.ArgumentParser:
    ...
    # Data source: either USDZ glob or trajdata config (mutually exclusive)
    data_source_group = parser.add_mutually_exclusive_group(required=True)
    data_source_group.add_argument(
        "--usdz-glob",
        type=str,
        help="Glob pattern for USDZ files (e.g., 'data/**/*.usdz')"
    )
    data_source_group.add_argument(
        "--trajdata-config",
        type=str,
        help="Path to JSON/YAML file containing trajdata dataset configuration"
    )
    parser.add_argument(
        "--log-dir",
        type=str,
